...
<head>
    <meta charset="UTF-8">
    <title>Servicio en mantenimiento - EncargaYa</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen text-center px-4">
    ...
    <div class="max-w-xl bg-white p-8 rounded-xl shadow-lg border border-gray-200">
        ...
        <h1 class="text-4xl font-extrabold text-yellow-500 mb-2">503</h1>
        <h2 class="text-2xl font-bold text-indigo-900 mb-4">¡Estamos en mantenimiento!</h2>
        <p class="text-gray-600 mb-6">Volveremos en breve. Gracias por tu paciencia.</p>
