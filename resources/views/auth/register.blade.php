...
<body class="bg-gray-100 text-gray-800 m-0 p-0">
    ...
    <section
        ...
        <div
            ...
            <div class="relative bg-gradient-to-br from-indigo-600 via-purple-700 to-indigo-800 text-white flex flex-col justify-center p-6 sm:p-10 overflow-hidden">
                <!-- Fondo animado con burbujas -->
                <div class="absolute inset-0 pointer-events-none z-0">
                    <div class="absolute top-6 left-6 w-20 h-20 sm:w-32 sm:h-32 bg-indigo-400 opacity-30 rounded-full blur-2xl animate-bounce-slow"></div>
                    <div class="absolute bottom-10 right-8 w-24 h-24 sm:w-40 sm:h-40 bg-purple-300 opacity-20 rounded-full blur-3xl animate-float"></div>
                    <div class="absolute top-1/2 left-1/2 w-12 h-12 sm:w-24 sm:h-24 bg-yellow-300 opacity-10 rounded-full blur-2xl animate-pulse"></div>
                    <div class="absolute bottom-2 left-1/3 w-8 h-8 sm:w-16 sm:h-16 bg-indigo-200 opacity-20 rounded-full blur-xl animate-float-reverse"></div>
                </div>
                <div class="relative flex justify-center mb-6 sm:mb-10">
                    <span class="absolute inset-0 flex items-center justify-center">
                        <span class="animate-spin-slow rounded-full border-2 sm:border-4 border-yellow-300 border-t-indigo-500 border-b-purple-400 w-24 h-24 sm:w-40 sm:h-40"></span>
                    </span>
                ...
                <h1 class="relative z-10 text-2xl sm:text-3xl font-bold leading-snug drop-shadow-lg text-center sm:text-left">Regístrate en <span class="text-yellow-300">EncargaYa</span>
                </h1>
            ...
            <div class="p-4 sm:p-10 bg-white flex items-center justify-center">
                <form id="registerForm" method="POST" action="{{ route('register') }}"
                    ...
                    <!-- Nombre -->
                    <div>
                        <label for="name" class="block text-xs sm:text-sm font-medium text-gray-700">Nombre completo</label>
                    ...
                    <!-- Celular -->
                    <div>
                        <label for="celular" class="block text-xs sm:text-sm font-medium text-gray-700">Número de celular</label>
                    ...
                    <!-- Confirmar -->
                    <div>
                        <label for="password_confirmation" class="block text-xs sm:text-sm font-medium text-gray-700">Confirmar
                            contraseña</label>
                        <div class="relative">
                    ...
                    <div id="summaryModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
                        <div class="bg-white rounded-lg shadow-lg max-w-xs sm:max-w-sm w-full p-4 sm:p-6 relative">
                            <h3 class="text-base sm:text-lg font-bold mb-2 sm:mb-4 text-gray-700">Confirmar registro</h3>
                            <div id="summaryContent" class="mb-2 sm:mb-4 text-gray-600 text-xs sm:text-sm"></div>
                            <div class="flex justify-end space-x-2">
                                <button onclick="closeSummaryModal()" class="px-3 py-2 bg-gray-200 rounded hover:bg-gray-300 text-xs sm:text-base">Cancelar</button>
                                <button onclick="submitRegisterForm()" class="px-3 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 text-xs sm:text-base">Confirmar</button>
                            </div>
