...
<body class="bg-gray-100 text-gray-800 m-0 p-0">
    ...
    <section
        ...
        <div
            ...
            <h1 class="text-base xs:text-lg sm:text-2xl md:text-4xl font-bold leading-snug text-center">Bienvenido a <span
            ...
            <div class="w-full max-w-full xs:max-w-full sm:max-w-sm">
                <h2 class="text-base xs:text-lg sm:text-2xl font-bold text-center mb-2 xs:mb-3 sm:mb-6 text-gray-700">Iniciar Sesión</h2>
                @if (session('status') === 'password-updated')
                <div class="mb-2 xs:mb-3 p-2 xs:p-3 bg-green-100 text-green-700 rounded-md shadow-sm text-center text-xs xs:text-sm">
