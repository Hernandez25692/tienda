...
<head>
    ...
    <style>
        ...
        :root {
            --navbar-height: 5rem; /* 80px, igual que h-20 */
        }
        @media (max-width: 768px) {
            :root {
                --navbar-height: 4.5rem; /* 72px para móviles */
            }
        }
    </style>
</head>
...
<body class="font-sans antialiased bg-gray-100 min-h-screen">
    ...
    @auth
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
                <div class="flex justify-between items-center h-full">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('productos.index') }}" class="group transition duration-300 flex items-center space-x-2">
                            <span
        ...
        <div
            class="w-full"
            style="padding-top: var(--navbar-height); min-height: 100vh;"
        >
            @isset($header)
