...
<body class="font-sans antialiased bg-gray-100">
    ...
    @auth
        <!-- Navbar superior - Solo diseño mejorado -->
        <nav x-data="{ open: false, dropdownOpen: false }" class="fixed top-0 left-0 w-full bg-white shadow-lg z-50 border-b border-gray-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <!-- Menú desktop - Estructura original con mejor diseño -->
