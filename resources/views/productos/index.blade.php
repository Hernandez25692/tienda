<x-app-layout>
    ...
    <div class="container mx-auto px-2 sm:px-4 bg-gray-100 min-h-screen py-2 sm:py-4">
        ...
        <div x-data="{ open: false, showAdvanced: false }" class="mb-2 sm:mb-4">
            ...
            <!-- Modal -->
            <div x-show="open" x-transition.opacity class="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-40" role="dialog" aria-modal="true" id="modal-filtros">
                <div 
                    ...
                    <form method="GET" action="{{ route('productos.index') }}" class="flex flex-col gap-2 overflow-y-auto" style="max-height: 70vh;">
                        ...
                        <div x-data="{ open: false }" class="mt-1">
                            <button type="button" @click="open = !open"
                                ...
                                Más filtros
                                <svg :class="{'rotate-180': open}" class="w-4 h-4 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
        ...
        >
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow group relative flex flex-col p-1 sm:p-3 min-h-0 h-full transition-all duration-200" role="listitem">
                <a href="{{ route('productos.show', $producto->id) }}" class="block rounded-lg overflow-hidden aspect-square bg-gray-100 flex items-center justify-center h-36 sm:h-44 focus:outline-none focus:ring-2 focus:ring-yellow-400" tabindex="0">
                    ...
                    <img src="{{ asset('storage/' . $producto->imagenes->first()->ruta) }}"
                        ...
                        loading="lazy">
                    @else
                    <svg class="w-10 h-10 text-gray-300" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div class="absolute top-2 right-2 flex-col gap-1 hidden sm:flex group-hover:flex z-10">
                    <a href="{{ route('productos.edit', $producto) }}"
                        ...
                        <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="{{ route('productos.show', $producto->id) }}" class="sm:hidden absolute inset-0 z-0" tabindex="-1" aria-label="Ver producto"></a>
            </div>
            @endforeach
        </div>
